...
def main():
    ...
    aa("--model_name", default="/home/wangyi/model/Qwen2.5-7B-Instruct", choices=["gpt2-xl", "EleutherAI/gpt-j-6B"])
    aa("--dataset", default="wikipedia", choices=["wikitext", "wikipedia"])
    aa("--layers", default=[7,8], type=lambda x: list(map(int, x.split(","))))
    ...
    model = AutoModelForCausalLM.from_pretrained(args.model_name,torch_dtype=torch.bfloat16).eval().cuda()
    ...
    for layer_num in args.layers:
        ...
        proj_layer_name = "down_proj" if "gpt2" in args.model_name else "down_proj"
