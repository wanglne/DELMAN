...
def compute_v_star(
    ...
    target_ids = tok(request["target_new"], return_tensors="pt", add_special_tokens=False).to("cuda")["input_ids"][0]
    tgt_str = request["target_new"]
    ...
    try:
        ...
        delta = torch.zeros((model.config.text_config.hidden_size,), requires_grad=True, device="cuda")
